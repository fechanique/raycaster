level = [
    {
        ...
        points : [
            ...
            [2000, 500, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1800, 500, 'brick.png', 0, 0, 0, 1, 1, 0, 0],

            [1800, 100, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1300, 100, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1300, 900, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1800, 900, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1800, 500, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
    ...
    },
    {
        name:'pool_wall',
        points : [
            [1800, 500, 'ceiling.png', 0, 0, 0, 1, 1, 0, 0],
            [1800, 100, 'ceiling.png', 0, 0, 0, 1, 1, 0, 0],
            [1300, 100, 'ceiling.png', 0, 0, 0, 1, 1, 0, 0],
            [1300, 900, 'ceiling.png', 0, 0, 0, 1, 1, 0, 0],
            [1800, 900, 'ceiling.png', 0, 0, 0, 1, 1, 0, 0],
            [1800, 500, 'ceiling.png', 0, 0, 0, 1, 1, 0, 0],

            [1850, 500, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1850, 950, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1250, 950, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1250, 50, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1850, 50, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
            [1850, 500, 'brick.png', 0, 0, 0, 1, 1, 0, 0],
        ],
        z0 : -220, z1 : 10,
        ceil: ['ceiling.png', 0, 0, 0, 1, 1, 0, 0], 
    ...
    },
    {
        name:'pool_water',
        points : [
            [1800, 100, 'glass.jpg', -0.5, -0.5, 0, 1, 1, 0, 0],
            [1300, 100, 'glass.jpg', -0.5, -0.5, 0, 1, 1, 0, 0],
            [1300, 900, 'glass.jpg', -0.5, -0.5, 0, 1, 1, 0, 0],
            [1800, 900, 'glass.jpg', -0.5, -0.5, 0, 1, 1, 0, 0],
        ],
        z0 : -100, z1 : 0,
        ceil: ['glass.jpg', -0.5, -0.5, 0, 0.5, 0.5, 0, 0], 
        floor: ['glass.jpg', -0.5, -0.5, 0, 0.2, 0.2, 0, 0],
        x:0, y:0, r:0,
